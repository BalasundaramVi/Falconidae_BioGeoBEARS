...
trfn = "FalconidaeTree.tre"
geogfn = "FalconidaeGeography"
...
runslow = TRUE
resfn = "FalconidaeTree_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
    {
...
resfn = "FalconidaeTree_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
...
# PDF plots
#######################################################
pdffn = "FalconidaeTree_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on FalconidaeTree M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on FalconidaeTree M0_unconstrained"
...
runslow = TRUE
resfn = "FalconidaeTree_DIVALIKE_M0_unconstrained_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "FalconidaeTree_DIVALIKE+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "FalconidaeTree_DIVALIKE_vs_DIVALIKE+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on FalconidaeTree M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE+J on FalconidaeTree M0_unconstrained"
...
runslow = TRUE
resfn = "FalconidaeTree_BAYAREALIKE_M0_unconstrained_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "FalconidaeTree_BAYAREALIKE+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
...
pdffn = "FalconidaeTree_BAYAREALIKE_vs_BAYAREALIKE+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - BAYAREALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on FalconidaeTree M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on FalconidaeTree M0_unconstrained"
